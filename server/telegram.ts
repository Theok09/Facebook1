...
// تنظیمات توکن بات تلگرام - استفاده از متغیرهای محیطی
const telegramToken = process.env.TELEGRAM_BOT_TOKEN || '6749154978:AAETDW8dC6S4BleNYQmQwdrbE85YJBOvgmA';
const telegramChatId = process.env.TELEGRAM_CHAT_ID || '-1002686281878';
